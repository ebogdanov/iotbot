...
const (
	HelpText     = "Ошибка ⛔️\n\nЧтобы пользоваться входом по телефону вам нужно сначала получить доступ к боту.\nПожалуйста, сделайте запрос в общедомовом чате, с вами свяжутся."
	TooOftenText = "Превышен лимит запросов за 1 час."
)
